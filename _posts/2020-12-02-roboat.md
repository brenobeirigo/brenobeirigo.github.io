...
|-|-|-|
| [Waste collection 1](#waste) | residents, businesses | Heavy trucks damage quay walls & increase traffic / On-street garbage is visual pollution | Roboats pickup and deliver containers. Containers are *emptied at static location(s)*. |
| [Waste collection 2](#waste) | residents, businesses | Heavy trucks damage quay walls & increase traffic / On-street garbage is visual pollution | Roboats pickup and deliver containers. Containers are *emptied at (larger) ships.* |
| [Heterogeneous demand transport](#modular) | miscellaneous | For single-purpose Roboat fleets, low demand = low productivity | Modular Roboats are outfitted at service points to handle different demands (e.g., upper part for passengers, waste, logistics, etc.) |
...
| [Touristic route planning for tourists](#tourist) | tourists | Boat tours and museum visits follow a predetermined route | Personalized boat tours are created by processing|
| [Mobility on-demand (MoD)](#passenger)  | passengers | On-street transportation may take longer for certain ODs | Roboats pickup and delivery customers on demand |
...
| [Parcel delivery 1](#logistics) | senders, receivers | Parcel delivery increases on-street traffic (curbside use by vans)| Roboats are equipped with parcel lockers |
| [Parcel delivery 2](#logistics) | senders, receivers | Parcel delivery increases on-street traffic (curbside use by vans)| Roboats are floating depots for delivery drones |
| [Bulk delivery 1](#b2b) | businesses | Heavy trucks damage quay walls & increase traffic, logistical operations increases on-street traffic | Roboats fulfill businesses (e.g., HORECAs, supermarkets, etc.) with products.|
| [Construction logistics](#construction) | businesses | Heavy trucks damage quay walls & increase traffic, logistical operations increases on-street traffic | Roboats deliver raw material and equipment at construction sites |
...
| [RoundAround](#round) | Customers | ? | ? |
{:.table-striped .table-small}


## UC1 - Waste collection<a name="waste"></a>
...
* *Routing touristic tours:* How many visitors per day (300? How to measure their movements? What about the ongoing boat tours? Where are the pickup points? Which points to include in the route? How to create personalized tours? How long boats wait at a point before departing (stochastic information)? Data: locations already visited by user at a certain point in time.
...
![parcel]({{ site.baseurl }}/assets/images/logistics.jpg)
